    ...
    <v-bottom-sheet v-model="sheet" >
      <v-btn slot="activator"
       ...
       dark>See who's online, chat!</v-btn>
        <v-layout >
          <v-flex d-flex xs2 offset-xs2>
            <v-card color="green" dark>
              <v-card-title primary class="title">Chats</v-card-title>
              <v-card-text>
              <v-btn dark icon>
              ...
              <v-layout row wrap>
                <v-flex d-flex>
                  <v-card color="grey" dark>
                    <v-card-media height="300px" src="https://picsum.photos/300/400?image=1050">
                      <span class="headline white--text pl-3 pt-3">San Antonio, Texas</span>
                    </v-card-media>
                    <v-card-text class="pl-3">Tom where have you been...
                    </v-card-text>
                  </v-card>
                </v-flex>
              </v-layout>
              ...
              <v-list two-line class="grey lighten-3">
                <template v-for="(item, index) in items">
                  ...
                  <v-list-tile avatar
                    ...
                    <v-list-tile-content>
                      <v-list-tile-title v-html="item.title" class="black--text"></v-list-tile-title>
                      <v-list-tile-sub-title v-html="item.subtitle" class="black--text"></v-list-tile-sub-title>
                    </v-list-tile-content>
                  </v-list-tile>
                </template>
            </v-list>
